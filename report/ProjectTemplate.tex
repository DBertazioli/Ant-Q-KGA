...
\item pr1002
\end{itemize}
Such a choice because they are often used and largely cited in literature. %allowing us to compare our results with others.%FIXME: le comparazioni con la letteratura non le mettiamo (?).
