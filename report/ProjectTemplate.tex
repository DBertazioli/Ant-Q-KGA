...
\item a comparison between the two algorithms can be done in terms of the percentage variation, and it can be clearly stated that the Ant-Q has slightly better performances, especially in providing the best solution and typically having a better average execution time (even though the magnitude order remains similar between the two algorithms).
