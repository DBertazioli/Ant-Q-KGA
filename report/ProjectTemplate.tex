...
The \textbf{K-Means Genetic Algorithm} (KGA) is composed by 
\paragraph{K-Means:} The \textit{K-Means} method is designed to partition a set of data into \textit{K} classes with \textit{K} chosen as desired.
