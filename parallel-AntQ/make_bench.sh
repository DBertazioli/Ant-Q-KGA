...
# d198
# a280
echo "Performance Test for Ant-Q"
for i in {0..4} #set n_repeat here
    do 
    echo "\n\n****dj38****\n\n"
    time mpirun -n 4 python3 main.py test/dj38 38 500 1 3 0.5 $i
    echo "time mpirun -n 4 python3 main.py test/dj38 38 100 1 3 0.5 $i"
    done
...
for i in {0..4} #set n_repeat here
    ...
    echo "time mpirun -n 4 python3 main.py test/berlin52 52 1000 1 3 0.5 $i"
    done

for i in {0..4} #set n_repeat here
    do 
    echo "\n\n****ch130****\n\n"
    time mpirun -n 4 python3 main.py test/ch130 130 1000 1 3 0.5 $i
    echo "time mpirun -n 4 python3 main.py test/ch130 130 1000 1 3 0.5 $i"
    done
    
for i in {0..4} #set n_repeat here
    do 
    echo "\n\n****d198****\n\n"
    time mpirun -n 4 python3 main.py test/d198 198 1000 1 3 0.5 $i
    echo "time mpirun -n 4 python3 main.py test/d198 198 1000 1 3 0.5 $i"
    done    

#for i in {0..4} #set n_repeat here
#  do 
     #time mpirun --hostfile hostfile -n 2 python3 main.py test/pr76 76 30 1 3 0.5 $i
     #time mpirun -n 2 python3 main.py test/a280 280 100 1 3 0.5 $i 
